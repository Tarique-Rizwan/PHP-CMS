...
(1, 1, 'Babu Sindhi', 'babusindhi@yahoo.com', 'I love HTML because it is simple enough to learn', 'approved', '2023-05-16');
...
(1, 1, 'HTML', '', 'Simba', '2023-05-16', 'html.png', '<p>Hypertext Markup Language is the standard markup language for creating web pages and web applications. With Cascading Style Sheets and JavaScript, it forms a triad of cornerstone technologies for the World Wide Web.</p>', 'Hyper Text Markup Language, HTML, Language', 0, 'published', 3),
(2, 2, 'CSS', '', 'Simba', '2023-05-16', 'css.png', '<p>Cascading Style Sheets is a style sheet language used for describing the presentation of a document written in a markup language like HTML. CSS is a cornerstone technology of the World Wide Web, alongside HTML and JavaScript.</p>', 'cacading, styles, sheet, CSS, design', 0, 'published', 0),
(3, 3, 'JavaScript', '', 'Simba', '2023-05-16', 'javascript.png', '<p>JavaScript, often abbreviated as JS, is a high-level, interpreted programming language. It is a language which is also characterized as dynamic, weakly typed, prototype-based and multi-paradigm.</p>', 'js, javascript, animation, validation', 0, 'published', 0),
(4, 4, 'jQuery', '', 'Simba', '2023-05-16', 'jquery.jpg', '<p>jQuery is a cross-platform JavaScript library designed to simplify the client-side scripting of HTML. It is free, open-source software using the permissive MIT License.</p>', 'jQuery, front-end, minified, fast', 0, 'published', 0),
(5, 5, 'PHP', '', 'Simba', '2023-05-16', 'php.png', '<p>PHP: Hypertext Preprocessor is a server-side scripting language designed for web development but also used as a general-purpose programming language.</p>', 'PHP, Hyper, Text, Pre Processor, Back-End, Programming, Language', 0, 'published', 0);
